# Generated by Django 3.2.19 on 2023-07-11 16:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(blank=True, choices=[('male_neutered', 'Male neutered'), ('male_unneutered', 'Male unnteuered'), ('female_spayed', 'Female spayed'), ('female_unspayed', 'Female unspayed')], max_length=32)),
                ('location', models.CharField(blank=True, max_length=255)),
                ('age', models.CharField(blank=True, max_length=255)),
                ('breed', models.CharField(blank=True, max_length=255)),
                ('adoptionrequest', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adoptionrequest.adoptionrequest')),
